...
local cjson_tests = {
    ...
    { "Decode invalid number exponent [throw error]",
      json.decode, { '[ 0.4eg10 ]' }, -- json.decode, { '[ 0.4eg10 ]' },
      false, { "Expected comma or array end but found invalid token at character 7" } },
    ...
    { "Encode empty array",
      json.encode, { { } }, true, { '[]' } },
    { "Encode integers",
      json.encode, { { 3, 10, 199, 2333, 35555, 46666, 567890, -12, -554474455} }, true,
	  { "[3,10,199,2333,35555,46666,567890,-12,-554474455]" } },
    { "Encode number",
      json.encode, { 10.0 }, true, { '10.' } },
    { "Encode string",
    ...
    { "Decode invalid hexadecimal",
      json.decode, { '0x6.ffp1' }, false, { "Expected the end but found invalid token at character 4" } },
    { "Decode numbers with leading zero",
      json.decode, { '[ 0000123, 0000.32 ]' }, true, { { 123, 0.32 } } },
    { "Decode +-Inf",
    ...
    { "Decode numbers with leading zero [throw error]",
      ...
      false, { "Expected value but found invalid token at character 9" } },
   ...
   --    json.decode, { testdata.utf16_escaped }, true, { testdata.utf8_raw } },
    ...
    { "Set encode_number_precision(0) [throw error]",
      ...
      false, { "bad argument #1 to 'lua_cjson.encode_number_precision' (expected integer between 1 and 16)" } },
    { "Set encode_number_precision(\"five\") [throw error]",
      json.encode_number_precision, { "five" },
      false, { "bad argument #1 to 'lua_cjson.encode_number_precision' (number expected, got string)" } },
    { "Set encode_keep_buffer(nil, true) [throw error]",
      json.encode_keep_buffer, { nil, true },
      false, { "bad argument #2 to 'lua_cjson.encode_keep_buffer' (found too many arguments)" } },
    { "Set encode_max_depth(\"wrong\") [throw error]",
      json.encode_max_depth, { "wrong" },
      false, { "bad argument #1 to 'lua_cjson.encode_max_depth' (number expected, got string)" } },
    { "Set decode_max_depth(0) [throw error]",
      json.decode_max_depth, { "0" },
      false, { "bad argument #1 to 'lua_cjson.decode_max_depth' (expected integer between 1 and 2147483647)" } },
    { "Set encode_invalid_numbers(-2) [throw error]",
      json.encode_invalid_numbers, { -2 },
      false, { "bad argument #1 to 'lua_cjson.encode_invalid_numbers' (invalid option '-2')" } },
    { "Set decode_invalid_numbers(true, false) [throw error]",
      json.decode_invalid_numbers, { true, false },
      false, { "bad argument #2 to 'lua_cjson.decode_invalid_numbers' (found too many arguments)" } },
    { "Set encode_sparse_array(\"not quite on\") [throw error]",
      json.encode_sparse_array, { "not quite on" },
      false, { "bad argument #1 to 'lua_cjson.encode_sparse_array' (invalid option 'not quite on')" } },
    ...
    { "Encode (safe) argument validation [throw error]",
      ...
      false, { "bad argument #1 to 'lua_cjson.safe.encode' (expected 1 argument)" } },
   ...
   -- Test encoding/decoding base64 to Long/Double
    { "encode_numbers_as_base64(...)",
      json.encode_numbers_as_base64, { true }, true, { true } },
    { "decode_numbers_as_base64(...)",
      json.decode_numbers_as_base64, { true }, true, { true } },
	{ "Encode number",
	   json.encode, { 10.0 }, true, { "\"D=AAAAAAAAJEA=\"" } },
	{ "Encode number",
		json.encode, { -123.123 }, true, { "\"D=HVpkO9/HXsA=\"" } },
	{ "Encode number",
		json.encode, { 4621819117588971520.0 }, true, { "\"D=AAAAAAAJ0EM=\"" } },
	{ "Decode number",
		json.decode, { "\"D=AAAAAAAAJEA=\"" }, true, { 10.0 } },
	{ "Decode number",
		json.decode, { "\"D=HVpkO9/HXsA=\"" }, true, { -123.123 } },
	{ "Decode number",
		json.decode, { "\"D=AAAAAAAJ0EM=\"" }, true, { 4621819117588971520.0 } },
	{ "Ignore invalid",
		json.decode, { "\"D=AAA=\"" }, true, { "D=AAA=" } },
	{ "Ignore invalid",
		json.decode, { "\"D=va;dfjvnladkjv\"" }, true, { "D=va;dfjvnladkjv" } },
